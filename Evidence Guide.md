...
At first I had a problem with the web page reloading each time I liked or disliked a review which was anyoying. So instad of using a normal post request I tried to ues a get request. Which would not reload the page. But I could'nt get it to work since mabey get requests can only request data not modilfy it modify as I was doing with the like and dislike counts.
